...
| `{pd_vis_output}` | `docs/pd/{username}/{yymmdd}-{serial}-{topic}/{topic}.ui.md` | pd-vis |
| `{pd_vis_prototype}` | `docs/pd/{username}/{yymmdd}-{serial}-{topic}/{topic}.ui-prototype.html` | pd-vis (高保真) |
