...
description: Generic research engine (structured search + verification) for other skills that need research capability — called by pd-research, dev-design, brainstorming, etc., not invoked directly by users.
---
