...
For forms beyond these four — runtime call trees, UI component trees with state and module boundaries, and diff-shaped views — read `{NOCODE_SKILL_REF}/visual-forms.md`. Two standing rules from it apply here:
...
- Pick the smallest view that carries the point; see `{NOCODE_SKILL_REF}/visual-forms.md`.
