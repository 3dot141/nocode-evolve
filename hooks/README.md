...
```
rules/manifest.json  (唯一真值源: buckets + rules)
        │
...
```bash
node --test 'hooks/*.test.mjs'        # 全量单测（含 ../scripts/ 模块），当前 153 例
