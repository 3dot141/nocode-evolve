...
#   model-about / model-personal / model-karpathy / model-catalog-using / model-rule-catalog-1 / model-rule-catalog-2 / model-rule-catalog-3 / project
#
...
MODEL_SEGMENTS="model-about model-personal model-karpathy model-catalog-using model-rule-catalog-1 model-rule-catalog-2 model-rule-catalog-3 model-rule-catalog-4 model-rule-catalog-5"
