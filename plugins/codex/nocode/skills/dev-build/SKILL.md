---
name: dev-build
description: "Use to implement a confirmed Plan or a confirmed single-slice Bug repair."
---
...
Read `${PLUGIN_ROOT}/skills/references/design-traceability.md`, `${PLUGIN_ROOT}/skills/references/source-comment-contract.md`, and the execution reference selected in Step 1.
