---
name: dev-plan
description: "Use when a confirmed engineering design needs decomposition into dependency-ordered implementat…"
---
...
Read `${PLUGIN_ROOT}/skills/references/design-traceability.md` and `references/task-template.md` before writing tasks.
...
Use `$devflow` after explicit confirmation.
