---
name: dev-verify
description: "Use after Build to collect fresh evidence for the current design obligations before completion…"
---
...
Read `${PLUGIN_ROOT}/skills/references/design-traceability.md` and `references/evidence-template.md`.
