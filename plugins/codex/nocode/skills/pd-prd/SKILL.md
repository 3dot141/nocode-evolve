---
name: pd-prd
description: "Use when the user wants to write a product requirements document."
---
...
格式与 ID 约定见 `${PLUGIN_ROOT}/skills/references/path-conventions.md`，开始前 Read。
...
**路径与 ID 格式**：见 `${PLUGIN_ROOT}/skills/references/path-conventions.md`（Step 3 已 Read）。
