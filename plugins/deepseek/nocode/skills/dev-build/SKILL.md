...
Read `{DSH_NOCODE_SKILL_REF}/design-traceability.md`, `{DSH_NOCODE_SKILL_REF}/source-comment-contract.md`, and the execution reference selected in Step 1.
...
Use a text milestone list with at most one in-progress item. Build-to-Verify handoff uses `/dev-verify`.
