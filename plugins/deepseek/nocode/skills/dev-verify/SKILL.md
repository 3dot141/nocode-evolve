...
Read `{DSH_NOCODE_SKILL_REF}/design-traceability.md` and `references/evidence-template.md`.
...
Use a text milestone list with at most one in-progress item. Verify-to-Review handoff uses `/dev-review`.
