...
name: bkt
version: 0.26.5
description: Use when managing Bitbucket Data Center or Cloud repositories, PRs, branches, issues, webhooks, pipelines, authentication, or bkt CLI failures. Not for GitHub/GitLab or local-only Git operations.
metadata:
