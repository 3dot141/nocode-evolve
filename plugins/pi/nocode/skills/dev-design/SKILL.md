...
Read `{NOCODE_PLUGIN_ROOT}/skills/references/grilling-loop.md` and `references/grilling.md`. Use the type file only as a coverage check, never as the next-question script:
