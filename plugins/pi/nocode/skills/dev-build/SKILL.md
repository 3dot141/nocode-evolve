...
Read `{NOCODE_PLUGIN_ROOT}/skills/references/design-traceability.md`, `{NOCODE_PLUGIN_ROOT}/skills/references/source-comment-contract.md`, and the execution reference selected in Step 1.
