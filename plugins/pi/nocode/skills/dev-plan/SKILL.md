...
Read `{NOCODE_PLUGIN_ROOT}/skills/references/design-traceability.md` and `references/task-template.md` before writing tasks.
...
Use `/skill:devflow` after explicit confirmation.
