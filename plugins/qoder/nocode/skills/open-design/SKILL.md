---
name: open-design
description: Use by default when the user asks to create, redesign, inspect, export, or manage a visual artifact such as a website, landing page, dashboard, app screen, prototype, presentation, or deck; when they mention Open Design or `odcli`; or when a design-generation workflow should use the local Open Design installation.
---
