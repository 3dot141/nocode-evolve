...
Use for README top-level panoramas of directories with a real dataflow/pipeline/state machine; a directory without one should use a boundary diagram instead, not a fake stacked-box pipeline (README writing rules: `{QODER_PLUGIN_ROOT}/skills/references/readme-writing.md`).
