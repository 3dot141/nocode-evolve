...
格式与 ID 约定见 `{QODER_PLUGIN_ROOT}/skills/references/path-conventions.md`，开始前 Read。
...
**路径与 ID 格式**：见 `{QODER_PLUGIN_ROOT}/skills/references/path-conventions.md`（Step 3 已 Read）。
