...
Read `{QODER_PLUGIN_ROOT}/skills/references/design-traceability.md`, `{QODER_PLUGIN_ROOT}/skills/references/source-comment-contract.md`, and the execution reference selected in Step 1.
