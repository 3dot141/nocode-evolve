---
name: brainstorming
description: Use when the user asks to brainstorm, broaden ideas, explore possibilities, or when a request has multiple materially different plausible directions and wider exploration would improve the decision.
---
