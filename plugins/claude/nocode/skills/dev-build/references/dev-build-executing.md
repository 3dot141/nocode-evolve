...
开始前 Read `{NOCODE_SKILL_REF}/design-traceability.md`。Full 场景先核对 Plan 与 approved Design 的 `designRevision` / `designDigest`；它们与每个 task 的 `designCovers`、Files、验收标准一样属于 Scope Lock，主 agent 不得自行修改。
