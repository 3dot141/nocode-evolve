...
**Design doc:** `docs/plans/3dot141/260519-sediment-design.md`
...
Expected: 仅剩"设计文档"链接行（`docs/plans/3dot141/260514-user-wiki-distill-design.md`——这是历史 design doc 文件名，保留不动；其他位置应无残留）。
...
Expected: 仅剩 design doc 历史文件名引用（`docs/plans/3dot141/260514-user-wiki-distill-design.md`，作为 sow.md 里的设计文档链接保留）。其他场所无残留。
...
git add commands/sediment.md commands/sow/ commands/project-wiki-distill.md \
        ...
        docs/plans/3dot141/260519-sediment-design.md \
        docs/plans/3dot141/260519-sediment-design.html \
        docs/plans/3dot141/260519-sediment-plan.md
git status
