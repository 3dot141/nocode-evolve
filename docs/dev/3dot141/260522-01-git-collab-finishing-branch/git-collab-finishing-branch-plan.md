...
>
> **Spec source:** `docs/dev/3dot141/260522-01-git-collab-finishing-branch/git-collab-finishing-branch-design.md` (同目录). 本 plan 落实 spec 6 节 (背景 / 目标 / 架构 / 实现 / 方案选型 / 其他) 中「实现 → 影响 / 业务流」段为具体 task; 内容细节优先回查 spec 影响表 ①②③ 编号要点.
...
- [ ] **Step 7: Commit**
  ...
  git add docs/dev/3dot141/260522-01-git-collab-finishing-branch/git-collab-finishing-branch-design.md
...
- **HTML 不动**: design doc 改了的话 (Task 0 / Task 8 acceptance 结果记录), HTML 是派生物 (`docs/dev/**/*.html` gitignored), 实施时**不重 render**; 真要更新展示版用户主动跑 `nocode-evolve:design-doc-rendering`
