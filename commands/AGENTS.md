...
`distill.md`、`sow.md`、`plugin-dream.md`、`project-dream.md`、`plugin-distill.md`、`personal-dream.md` 等文件体量较大、内含完整执行流程；它们本身就是对应生成 Skill 的权威实现。源码 `skills/` 下找不到同名目录是正常的，adapter 会在两个发布物中生成。
